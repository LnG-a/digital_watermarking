...
class SVD():
    ...
    def watermark(self, img, path_save):
        '''
...
svd = SVD(watermark_path='input/SVDwatermark.jpg')
svd.watermark(img='input/SVDimage.jpg', path_save='output/SVDimage_output.jpg')
svd.extracted(extracted_watermark_path='output/SVDwatermark_output.jpg')